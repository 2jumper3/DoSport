...
public final class FlexiblePageControl: UIView {
    ...
    public struct Config {
        ...
        public init(displayCount: Int = 4,
                    dotSize: CGFloat = 12.0,
                    dotSpace: CGFloat = 8.0,
                    smallDotSizeRatio: CGFloat = 0.666,
    ...
    public var numberOfPages: Int = 0 {
        didSet {
            ...
            displayCount = max(config.displayCount, numberOfPages)
            update(currentPage: currentPage, config: config)
        }
    }
