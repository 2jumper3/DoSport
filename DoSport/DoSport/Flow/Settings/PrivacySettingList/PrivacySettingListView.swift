...
protocol PrivacySettingListViewDelegate: class { }
    
final class PrivacySettingListView: UIView {
    
    weak var delegate: PrivacySettingListViewDelegate?
...
extension PrivacySettingListView {
