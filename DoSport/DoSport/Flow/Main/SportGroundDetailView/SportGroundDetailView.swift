...
protocol SportGroundDetailViewProtocol: class {
}

final class SportGroundDetailView: UIView {
    
    weak var delegate: SportGroundDetailViewProtocol?
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collectionView.registerClass(SportGroindDetailHeaderCell.self)
        collectionView.registerClass(UserMainInfoCollectionCell.self)
        collectionView.registerClass(EventCardCollectioCell.self)
        collectionView.registerReusableView(CustomSegmentView3segment.self)
...
extension SportGroundDetailView {
