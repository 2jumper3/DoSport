...
//  DoSport
//
//  Created by Sergey on 09.03.2021.
//
...
class PriceTableViewCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        checkboxInfoLabel.snp.makeConstraints {
            ...
            $0.bottom.equalTo(contentView.snp.bottom).priority(999)
        }
    }
}

//MARK: Private API
 extension MembersCountCell {
}

//MARK: Actions

@objc private extension PriceTableViewCell {
